...
$(document).ready(function(){      
	...
	function init_template(){
        ...
        var colorsArray = [
            ...
            ["gray2","#CCD1D9","#555556","#88919d"],
            ["gray3","#777777","#777777","#777777"],
        ...
        function menuFunctions(){
            //Adding Menu Hider
            if(!$('.menu-hider').length){$('.prodcontent').append('<div class="menu-hider"><div>');}
            ...
            menu.each(function(){
                ...
                if($(this).hasClass('menu-box-med')){$(this).css("height",menuHeight);}           
                if($(this).hasClass('menu-box-modal')){$(this).css({"height":menuHeight, "width":menuWidth});}
            });    
            $('ul.pagination').hide();
            //Menu Deploy Click 
            $('#restaurant-products').on('click' , '[data-menu]',function(){     
                console.log('click');
                ...
                if(menuEffect === "menu-parallax"){
                    ...
                    if(menuID.hasClass('menu-box-med')){headerAndContent.css("transform", "translateY("+(menuHeight/5)+"px)");}       
                ...
                if(menuEffect === "menu-push"){
                    ...
                    if(menuID.hasClass('menu-box-med')){headerAndContent.css("transform", "translateX("+(menuWidth)+"px)");}       
                ...
                var loader = menuID.data('menu-load');
               
                if(menuID.html().length > 100) console.log('exist');
                else menuID.load(loader , function(){
                    setTimeout(function(){
                        darkMode();
                        // menuFunctions();
                        sharingLinks();
                        ...
                        shape_changer();
                        setTimeout(function () {
                            menuID.find('.single-slider').owlCarousel({
                                rtl: true,
                                loop: true,
                                margin: 20,
                                nav: false,
                            ...
                            $('body').on('click' , '.menu-hider, .close-menu, .menu-close', function(){
                                console.log('close');
                                $('.menu').removeClass('menu-active');
                                $('.menu-hider').removeClass('menu-active menu-active-clear');
                                $('.header, .page-content, #footer-bar').css('transform','translate(0,0)');
                ...
                $('#page').on('click' , '.close-menu', function(){
               ...
               $('[data-menu]').on('click',function(){     
                ...
                var loader = menuID.data('menu-load');
                console.log('link : ' + loader);
                if(menuData == 'data-photo-show'){
                    
                    $('#offer-image').prop('src' , $(this).data('image'));
                }
                if((menuID.html() && menuID.html().length > 100) && (menuData != 'menu-package-details' || menuData == 'data-photo-show' )) console.log('exist ' + menuData);
                else menuID.load(loader , function(){
                    $('#cart-count').css('z-index' , 1);
                    setTimeout(function(){
                        darkMode();
                        // menuFunctions();
                        sharingLinks();
        ...
        function show_scroll_ad2(){scrollheight.addClass('scroll-height-visible');}
        function hide_scroll_ad2(){scrollheight.removeClass('scroll-height-visible');}        

        $(window).on('scroll', function () {
            var total_scroll_height = document.body.scrollHeight
            var inside_header = ($(this).scrollTop() <= 434);
            var passed_header = ($(this).scrollTop() >= 0); //250
            var passed_header2 = ($(this).scrollTop() >= 434); //250
       ...
       $(".text-size-default").click(function() {$(".text-size-changer *").css("font-size", "");});
        ...
        //Owl Carousel Sliders
        setTimeout(function(){
            $('.user-slider').owlCarousel({rtl:true, loop:false, margin:20, nav:false, lazyLoad:true, items:1, autoplay: false, dots:true, autoplayTimeout:4000});		
            $('.user-list-slider').owlCarousel({rtl:true, loop:false, margin:20, nav:false, stagePadding:0, lazyLoad:true, items:5, autoplay: false, dots:true, autoplayTimeout:4000});		
            $('.user-list-slider2').owlCarousel({rtl:true, loop:false, margin:10, nav:false, stagePadding:0, lazyLoad:true, items:5, autoplay: false, dots:true, autoplayTimeout:4000});
            $('.single-slider').owlCarousel({rtl:true, loop:true, dots:true, margin:20, nav:false, lazyLoad:true, items:1, autoplay: true, autoplayTimeout:4000});		
            ...
            $('.double-slider').owlCarousel({rtl:true,center: true, loop:true, margin:20, stagePadding:90, nav:false, lazyLoad:false, items:1, autoplay: true, autoplayTimeout:4000});		
            $('.double-slider2').owlCarousel({rtl:true, loop:false, margin:0, stagePadding:0, nav:false, lazyLoad:false, items:1, autoplay: false, autoplayTimeout:4000});		
            $('.double-slider3').owlCarousel({rtl:true, loop:false, margin:20, stagePadding:20, nav:false, lazyLoad:false, items:2, autoplay: false, autoplayTimeout:4000});		
            $('.double-slider4').owlCarousel({rtl:true, loop:false, margin:20, stagePadding:50, nav:false, lazyLoad:false, items:2, autoplay: false, autoplayTimeout:4000});		
          $('.double-slider5').owlCarousel({rtl:true, loop:false, margin:10, stagePadding:0, nav:false, lazyLoad:false, items:2, autoplay: false, autoplayTimeout:4000});		
          $('.double-slider6').owlCarousel({rtl:true, loop:false, margin:10, stagePadding:0, nav:false, lazyLoad:false, items:3, autoplay: false, autoplayTimeout:4000});		
 $('.task-slider').owlCarousel({rtl:true, loop:true, margin:30, nav:false, stagePadding:50, lazyLoad:true, items:2, autoplay: false, autoplayTimeout:4000});		
                ...
                if(pieChart.length){
                    var pieDemoChart = new Chart(pieChart, {
                        ...
                        data: {
                          ...
                          datasets: [{
                            backgroundColor: ["#f7b538", "#4FC1E9", "#A0D468"],
