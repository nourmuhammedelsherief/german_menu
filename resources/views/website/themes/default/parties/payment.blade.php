    ...
    <div class="container">
        ...
        <div class="details">
            ...
            <div class="data" style="position: relative;">
                ...
                <p style="">{{ $type == 'online' ? $totalPrice : $reservation->total_price }}
                    {{ $country->name }} <br>
        ...
        <form id="reservationForm" action="{{ route('party.payment.store', [$restaurant->id, $reservation->id]) }}"
