<div id="menu-prodact-100"
    ...
    class="menu menu-box-bottom menu-box-detached rounded-lp" data-menu-load="{{ route('loadMenuProduct', 100) }}"
    data-menu-height="100%" data-menu-effect="menu-over">
</div>


<div id="menu-restaurant-description"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-med menu-box-detached rounded-l" data-menu-height="auto" data-menu-effect="menu-over">
...
<div id="menu-map"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached" data-menu-height="300" data-menu-effect="menu-over">
...
<div id="menu-info"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached rounded-lp" data-menu-height="400" data-menu-effect="menu-over">
    ...
    <div class="content mb-0">
        ...
        <h3 class="font-700 text-center"
            style="color: {{ $restaurant->color == null ? '' : $restaurant->color->main_heads }}">@lang('messages.information')</h3>
        <div class="divider"></div>
        @include('website.' . session('theme_path') . 'silver.accessories.information')

    </div>
</div>
@if(isset($restaurant->id) and isset($table->id) and $restaurant->enable_waiter == 'true')
<!--- waiter call -------------------->
<div id="waiter-call"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached rounded-lp" data-menu-height="400" data-menu-effect="menu-over">
    ...
    <div class="content mb-0">
        ...
        <h3 class="font-700 text-center"
            style="color: {{ $restaurant->color == null ? '' : $restaurant->color->main_heads }}">@lang('messages.waiter_title')</h3>
        <div class="divider"></div>
        <form action="{{route('web.waiter.store' , $restaurant->id)}}" method="post">
            @csrf
            <input type="hidden" name="table_id" value="{{$table->id}}">
            @php
                $items = [];
                if(isset($table->branch->id)){
                    $items = $table->branch->waiterItems()->where('status' , 1)->orderBy('sort')->get();
                }
            @endphp
            <div class="waiter-request-items">
            ...
            <div class="form-group note">
                <label for="" style="">{{ trans('messages.request_note') }}</label>
...
<div id="menu-share-list"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="310" data-menu-width="320"
...
<div id="menu-rate-link"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    data-menu="menu-rate-link" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="310"
    ...
    <div class="content mb-0">
        ...
        <h3 class="font-700 text-center"
            style="color: {{ $restaurant->color == null ? '' : $restaurant->color->main_heads }}"> @lang('messages.restaurant_feedback')
        </h3>
        ...
        <div class="row buttons" style="max-width: 200px; margin: auto; margin-top:30px;">
            <div class="col-6">
                <a href="#" target="_blank" class="btn btn-primary yes" class="btn btn-primary float-right"
                    style="font-size: 0.8rem;" rel="noopener noreferrer">{{ trans('messages.yes') }}</a>
            </div>
            <div class="col-6">
                <button href="#" target="_blank" class="btn btn-secondary no" class="btn btn-secondary float-left"
                    style="font-size: 0.8rem">{{ trans('messages.no') }}</button>
            </div>
        </div>
    ...
    <div id="menu-rate"
        ...
        <div class="popup-content mb-0">
            <div class="popup-header"
                ...
                <h3 class="font-700 text-center"
                    style="color: {{ $restaurant->color == null ? '' : $restaurant->color->main_heads }}">
                    @lang('messages.restaurant_feedback')</h3>
                <h2 class="text-left"
                    style="color: {{ $restaurant->color == null ? '' : $restaurant->color->icons }} !important;">
                    {{-- <a class="a2a_dd icon-button share" href="https://www.addtoany.com/share"
...
<!------------------->
<!------------------->
<div id="menu-delv-list" class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="280"
    data-menu-width="320" data-menu-effect="menu-over"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;">
...
<div id="menu-photo-list"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="550" data-menu-width="320"
    data-menu-effect="menu-over">
...
<div id="data-photo-show"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu  ad-menu menu-box-bottom menu-box-detached rounded-m" {{-- data-menu-height="550" --}} data-menu-width="320"
    data-menu-effect="menu-over">
...
<div id="menu-allergy-list"
    style="background-color: {{ $restaurant->color == null ? '' : $restaurant->color->product_background }} !important;"
    class="menu menu-box-bottom menu-box-detached rounded-m" data-menu-height="350" data-menu-width="320"
    data-menu-effect="menu-over">
    ...
    <div class="popup-content mb-0">
        <div class="popup-header"
            ...
            <h3 class="font-700 text-center"
                style="color: {{ $restaurant->color == null ? '' : $restaurant->color->main_heads }}">
                @lang('messages.sensitivities')</h3>
            <div class="divider"></div>
        </div>
