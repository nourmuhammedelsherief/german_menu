...
<div id="menu-mapsico-list"
    ...
    <div class="content mb-0" >
        <div class="menu-box-header" style="background-color: {{$restaurant->color == null ? '' : $restaurant->color->product_background}} !important;">
            ...
            <h3 class="font-700 text-center" style="color: {{$restaurant->color == null ? '' : $restaurant->color->main_heads}}"> @lang('messages.the_branches') </h3>
        </div>
