...
<div id="menu-info"
    ...
    <div class="content mb-0">
        ...
        <h3 class="font-700 text-center">@lang('messages.information')</h3>
        <div class="divider"></div>
...
<div id="menu-share-list"
    ...
    <div class="popup-content mb-0">
        <div class="popup-header">
            ...
            <h3 class="font-700 text-center"> @lang('messages.follow_us')</h3>
            <h2 class="text-left"
...
<div id="menu-rate-link"
    ...
    <div class="content mb-0">
        ...
        <h3 class="font-700 text-center"> @lang('messages.restaurant_feedback')</h3>
...
<div id="menu-delv-list"
    ...
    <div class="popup-content mb-0">
        <div class="popup-header">
            ...
            <h3 class="font-700 text-center">@lang('messages.deliveries')</h3>
            <div class="divider"></div>
        </div>
...
<div id="menu-allergy-list"
    ...
    <div class="popup-content mb-0">
        <div class="popup-header">
            ...
            <h3 class="font-700 text-center"> @lang('messages.sensitivities')</h3>
            <div class="divider"></div>
        </div>
