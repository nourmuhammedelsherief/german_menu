<div class="rateUs px-4">
   <form id="form-rate-us" action="{{route('restaurant.rateUs' , $restaurant->id)}}" method="POST">
        ...
        <div class="form-group">
            <label for="">{{trans('dashboard.branches')}}</label>
        ...
        @endif
        <div class="form-group">
            <label for="">{{trans('dashboard.entry.message')}}</label>
        ...
        <div class="form-group rate-us " style="clear:both;" data-key="{{$key}}">
            ...
            <div class="float-right">{{ trans('dashboard._feedback.type.'.$key) }}</div>
