            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant.banks.store')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control" required>
                                        ...
                                        @foreach($countries as $country)
                                            <?php  $check_branch_country = \App\Models\Branch::whereRestaurantId(auth('restaurant')->user()->id)->where('country_id' , $country->id)->first(); ?>
                                            @if($country->id == auth('restaurant')->user()->country_id || $check_branch_country != null)
