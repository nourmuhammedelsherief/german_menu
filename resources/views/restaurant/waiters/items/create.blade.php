...
@section('title')
    @lang('messages.add') @lang('dashboard.waiter_requests')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('dashboard.waiter_requests') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.waiter_requests') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.waiter.items.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_ar" type="text" class="form-control"
                                           value="{{old('name_ar')}}" placeholder="@lang('dashboard.entry.name_ar')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_en" type="text" class="form-control"
                                           value="{{old('name_en')}}" placeholder="@lang('dashboard.entry.name_en')">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" >
                                        ...
                                        <option value="true" {{old('status') == 'true' ? 'selected' : ''}}> @lang('dashboard.yes') </option>
                                        <option value="false" {{old('status') == 'false' ? 'selected' : ''}}> @lang('dashboard.no') </option>
                ...
                if ($("#post-form").length > 0) {
                    $("#post-form").validate({
                        ...
                        submitHandler: function (form) {
                            ...
                            $.ajax({
                                url: "{{ route('restaurant.waiter.items.store') }}",
                                type: "POST",
