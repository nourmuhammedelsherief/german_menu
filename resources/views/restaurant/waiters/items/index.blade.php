...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.waiter_requests')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.waiter.items.index')}}"></a>
                            @lang('dashboard.waiter_requests')
                        </li>
                    </ol>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('restaurant.waiter.items.create')}}" class="btn btn-info">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($requests as $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{route('restaurant.waiter.items.edit' , $item->id)}}">
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/waiter/items/delete/" + id;
