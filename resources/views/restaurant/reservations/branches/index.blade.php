...
@section('title')
    @lang('dashboard.reservation_branches')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.reservation_branches')</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('restaurant.reservation.branch.create')}}" class="btn btn-info">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th> @lang('dashboard.entry.location_link') </th>
                            ...
                            @foreach($branches as $index => $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td style="text-align: center;">
                                        @if(!empty($item->location_link))
                                            <a href="{{$item->location_link}}" style="font-size:30px;" target="_blank" rel="noopener noreferrer">
                                    ...
                                    <td>
                                        <a href="{{route('restaurant.reservation.branch.edit' , $item->id)}}"
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/reservation/branch/delete/" + id;
