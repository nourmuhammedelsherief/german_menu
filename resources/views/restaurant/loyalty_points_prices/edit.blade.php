...
@section('title')
    @lang('messages.edit') @lang('dashboard.loyalty_point_prices')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('dashboard.loyalty_point_prices') </h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.loyalty_point_price.index')}}">
            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.loyalty_point_price.update' , $branch->id)}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="points" type="number" class="form-control"
                                           value="{{$branch->points}}" placeholder="@lang('messages.points')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="price" type="number" class="form-control"
                                           value="{{$branch->price}}" placeholder="@lang('messages.price')">
                                    @if ($errors->has('price'))
                                        <span class="help-block">
