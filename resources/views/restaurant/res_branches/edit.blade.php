                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('res_branches.index')}}">
            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('res_branches.update' , $branch->id)}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.location') </label>
                                    <input name="link" type="url" class="form-control" value="{{$branch->link}}"
