...
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('res_branches.index')}}"></a>
                            @lang('messages.the_branches')
                        </li>
                    </ol>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('res_branches.create')}}" class="btn btn-info">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($branches as $branch)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{$branch->link}}" target="_blank"> {{$branch->link}} </a>
                                    </td>
                                    <td>

                                        <a class="btn btn-info" href="{{route('res_branches.edit' , $branch->id)}}">
