                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <form role="form" id="post-form"
                            action="{{ $action == 'edit' ? route('restaurant.party.update', $party->id) : route('restaurant.party.store') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="t-image">
                                    <div class="form-group ">
                                        <label class="control-label col-md-12"> @lang('messages.image') </label>
                                        <div class="col-md-12">
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                <div class="fileinput-preview thumbnail" data-trigger="fileinput"
                                                    style="width: 200px; height: 150px; border: 1px solid black;">
                                                    @if ($action == 'edit' and !empty($party->image))
                                                        <img src="{{ asset($party->image_path) }}" alt="">
                                                    @endif
                                                </div>
                                                <div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea class="textarea" type="text" name="description_ar">{{ $action == 'edit' ? $party->description_ar : old('description_ar') }}</textarea>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <textarea type="text" name="description_en" class="textarea">{{ $action == 'edit' ? $party->description_en : old('description_en') }}</textarea>
                                        ...
                                        <div class="list">
                                            ...
                                            @elseif($action == 'edit')
                                                @foreach ($party->days as $index => $item)
                                                    ...
                                                    <div class="item">
                                                        <input type="hidden" name="dates[{{ $index }}][id]"
                                                            value="{{ $item->id }}">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="form-group col-md-3">
                                                                ...
                                                                <select class="form-control select2"
                                                                    name="additions[{{ $index }}][is_required]">
                                                                    <option value="0"
            ...
            $('.add-addition').on('click', function() {
                ...
                var content = '        <div class="item">\
                    ...
                    '][name_en]" class="form-control" required\
                                                    ...
                                                    <div class="form-group col-md-3">\
                                                        <label class="control-label"> @lang('dashboard.entry.price') </label>\
                                                        <input  type="number" name="additions[' + count + '][price]"  step="0.1" class="form-control" required\
                                                            >\
                                                    </div>\
                                                    <div class="form-group col-md-3">\
                                                                                <label class="control-label"> @lang('dashboard.entry.is_required') </label>\
                                                                                <select   name="additions[' + count + '][is_required]" class="form-control select2">\
