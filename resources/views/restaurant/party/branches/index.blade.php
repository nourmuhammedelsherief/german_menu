...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.party_branches')</h1>
                </div>
                <div class="col-sm-6">
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('restaurant.party-branch.create')}}" class="btn btn-info">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th> @lang('dashboard.party_count') </th>
                            ...
                            @foreach($branches as $index => $item)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a href="{{route('restaurant.party-branch.edit' , $item->id)}}"
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/party-branch/delete/" + id;
