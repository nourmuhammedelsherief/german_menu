...
@section('title')
    @lang('messages.edit') @lang('messages.order_seller_codes')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.order_seller_codes') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.order_seller_codes') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('order_seller_codes.update' , $code->id)}}" method="post"
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="branch_id" class="form-control" required>
                                        ...
                                        @foreach($branches as $branch)
                                            <option value="{{$branch->id}}" {{$code->branch_id == $branch->id ? 'selected' : ''}}>
                                                @if(app()->getLocale() == 'ar')
                                                    {{$branch->name_ar}}
                                                @else
                                                    {{$branch->name_en}}
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="seller_code" type="number" class="form-control"
                                           value="{{$code->seller_code}}" placeholder="@lang('messages.seller_code')">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-10">
                                            <input name="discount_percentage" type="number" class="form-control"
                                                   value="{{$code->discount_percentage}}" placeholder="@lang('messages.discount_percentage')">
                                        </div>
                                        <div class="col-sm-2">
                                            %
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="start_at" type="date" class="form-control"
                                           value="{{$code->start_at->format('Y-m-d')}}" placeholder="@lang('messages.start_at')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="end_at" type="date" class="form-control"
                                           value="{{$code->end_at->format('Y-m-d')}}" placeholder="@lang('messages.end_at')">
