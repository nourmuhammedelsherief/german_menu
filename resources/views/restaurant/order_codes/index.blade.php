...
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('order_seller_codes.index')}}"></a>
                            @lang('messages.order_seller_codes')
                        </li>
                    </ol>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('order_seller_codes.create')}}" class="btn btn-info">
                            ...
                            @foreach($codes as $code)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{route('order_seller_codes.edit' , $code->id)}}">
        ...
        $(document).ready(function () {
            $('body').on('click', '.delete_data', function () {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/order_seller_codes/delete/" + id;
