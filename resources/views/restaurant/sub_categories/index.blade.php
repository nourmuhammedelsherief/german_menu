                            ...
                            @foreach($sub_categories as $sub_category)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-info" href="{{route('sub_categories.edit' , $sub_category->id)}}">
                                            <i class="fa fa-user-edit"></i> @lang('messages.edit')
                                        </a>
                                        <a class="delete_data btn btn-danger" data="{{ $sub_category->id }}" data_name="{{ app()->getLocale() == 'ar' ? ($sub_category->name_ar == null ? $sub_category->name_en : $sub_category->name_ar) : ($sub_category->name_en == null ? $sub_category->name_ar : $sub_category->name_en) }}" >
        ...
        $( document ).ready(function () {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/restaurant/sub_categories/delete/" + id;
