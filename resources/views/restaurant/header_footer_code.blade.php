                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('restaurant.add_code')}}">
            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.add_code')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="header" type="text" class="form-control" rows="6"
                                            placeholder="@lang('dashboard.header') ...">{!! $restaurant->header !!}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="footer" type="text" class="form-control" rows="6"
                                            placeholder="@lang('dashboard.footer') ...">{!! $restaurant->footer !!}</textarea>
