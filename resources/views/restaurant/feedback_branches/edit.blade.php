                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('dashboard.branches') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('restaurant.feedback.branch.update' , $branch->id)}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="link" type="text" class="form-control"
                                           value="{{$branch->link}}" placeholder="@lang('messages.link')">
                                    @if ($errors->has('link'))
                                        <span class="help-block">
