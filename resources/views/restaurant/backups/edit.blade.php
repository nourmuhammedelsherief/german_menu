            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('restaurant.banks.update' , $bank->id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select name="country_id" class="form-control" required>
                                        ...
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}" {{$bank->country_id == $country->id ? 'selected' : ''}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_ar" type="text" class="form-control" value="{{$bank->name_ar}}" placeholder="@lang('messages.name_ar')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name_en" type="text" class="form-control" value="{{$bank->name_en}}" placeholder="@lang('messages.name_en')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="useful" type="text" class="form-control" value="{{$bank->useful}}" placeholder="@lang('messages.useful')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="account_number" type="text" class="form-control" value="{{$bank->account_number}}" placeholder="@lang('messages.account_number')">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="IBAN_number" type="text" class="form-control" value="{{$bank->IBAN_number}}" placeholder="@lang('messages.IBAN_number')">
