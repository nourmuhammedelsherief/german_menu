        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    لسحب المينو سيتم حذف البيانات الفروع و الاقسام المينو و المنتجات و استراجعها من حسابك في فودكس. هل انت
                    موفق علي السحب؟
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">اغلق</button>
                    <a href="{{ route('pull_menu', $restaurant->id) }}"  class="btn btn-primary">سحب
                        المينو</a>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            $('body').on('click', '.delete_data', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/remove_foodics_integration/" +
                        id;
