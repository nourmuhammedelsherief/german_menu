...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.previous_orders')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('employeePreviousOrders' , $status)}}"></a>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                ...
                <div class="card">
                    <div class="col-sm-3">
                        <a href="{{route('employeePreviousOrders' , $status)}}" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th> @lang('messages.order_created_at') </th>
                                <th> @lang('messages.order_receipt_at') </th>
                            ...
                            @foreach($orders as $order)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <button type="button" class="btn btn-primary" data-toggle="modal"
                                                data-target="#modalreceipt-{{$order->id}}">
                                            @lang('messages.show')
                                        </button>
                                        <div class="modal fade" id="modalreceipt-{{$order->id}}">
                                            <div class="modal-dialog">
                                                <div class="modal-content bg-default">
                                                    <div class="modal-header">
                                                        <h4 class="modal-title">
                                                            @lang('messages.order_receipt_at')
                                                        </h4>
                                                        <button type="button" class="close" data-dismiss="modal"
                                                                aria-label="Close">
                                                            <span aria-hidden="true">&times;</span></button>
                                                    ...
                                                    <div class="modal-body">
                                                        @if($order->period)
                                                            <p>
                                                                @lang('messages.receipt_period')
                                                                <br>
                                                                @lang('messages.start_at')
                                                                <span style="color: blue">
                                                              
                                                                    {{ $order->period->start_at }}
                                                            </span>
