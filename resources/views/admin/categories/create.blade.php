...
@section('title')
    @lang('messages.add') @lang('messages.categories')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.add') @lang('messages.categories') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.add') @lang('messages.categories') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
