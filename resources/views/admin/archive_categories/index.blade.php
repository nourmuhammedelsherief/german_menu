...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('messages.archive_categories')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('archive-categories.index')}}"></a>
                            @lang('messages.archive_categories')
                        </li>
                    </ol>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('archive-categories.create')}}" class="btn btn-info">
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach($categories as $city)
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{$city->name_en}} </td>
                                    <td>
                                        <a class="btn btn-info" href="{{route('archive-categories.edit' , $city->id)}}">
            ...
            $('body').on('click', '.delete_city', function() {
                ...
                swal({
                    ...
                    {{--var url = '{{ route("imageProductRemove", ":id") }}';--}}
                        ...
                        window.location.href = "{{ url('/') }}" + "/admin/archive-categories/delete/"+id;
