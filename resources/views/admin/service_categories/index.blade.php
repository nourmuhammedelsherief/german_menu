...
@section('content')
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('admin.service_category.index' )}}"></a>
                            @lang('messages.service_categories')
                        </li>
                    </ol>
                </div>
    ...
    <section class="content">
        <div class="row">
            <div class="col-12">
                <h3>
                    <a href="{{route('admin.service_category.create')}}" class="btn btn-info">
                    ...
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <th>@lang('messages.service_count')</th>
                            ...
                            @foreach($categories as $category)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn btn-info" href="{{route('admin.service_category.edit' , $category->id)}}">
            ...
            $('body').on('click', '.delete_city', function() {
                ...
                swal({
                    ...
                    {{--var url = '{{ route("imageProductRemove", ":id") }}';--}}
                        ...
                        window.location.href = "{{ url('/') }}" + "/admin/service_category/delete/"+id;
