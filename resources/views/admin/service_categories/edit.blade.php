...
@section('title')
    @lang('messages.edit') @lang('messages.service_categories')
@endsection
                ...
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.service_categories') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('admin.service_category.update' , $category->id)}}" method="post" enctype="multipart/form-data">
