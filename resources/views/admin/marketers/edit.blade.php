...
@section('title')
    @lang('messages.edit') @lang('messages.marketers')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('messages.marketers') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-8">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('messages.marketers') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{route('marketers.update' , $marketer->id)}}" method="post" enctype="multipart/form-data">
                            <input type = 'hidden' name = '_token' value = '{{Session::token()}}'>

                            <div class="card-body">
                                <div class="form-group">
                                    <label class="control-label"> @lang('messages.marketer_name') </label>
                                    <input name="name" type="text" class="form-control" value="{{$marketer->name}}" placeholder="@lang('messages.marketer_name')">
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="email" type="email" class="form-control" value="{{$marketer->email}}" placeholder="@lang('messages.email')">
                                    @if ($errors->has('email'))
                                        <span class="help-block">
