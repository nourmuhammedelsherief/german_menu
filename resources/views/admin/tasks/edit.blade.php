...
@section('title')
    @lang('messages.edit') @lang('dashboard.tasks')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1> @lang('messages.edit') @lang('dashboard.tasks') </h1>
                </div>
                <div class="col-sm-6">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">@lang('messages.edit') @lang('dashboard.tasks') </h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="datetime-local" name="worked_at" class="form-control" value="{{$task->worked_at}}" placeholder="@lang('dashboard.entry.worked_at')">
