            ...
            <div class="row">
                ...
                <!-- general form elements -->
                    <div class="card card-primary">
                        ...
                        @endif
                        <!-- form start -->
                        <form role="form" id="post-form" action="{{route('adminAds.store')}}" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="type" id="" class="form-control select2" required>
                                        ...
                                        @foreach (trans('dashboard._ads_type') as $key => $item)
                                             <option value="{{$key}}">{{trans('dashboard._ads_type.' . $key)}}</option>
                                        @endforeach
                                    </select>
                                    @if ($errors->has('type'))
                                        <span class="help-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="content_type" id="" class="form-control " >
                                        ...
                                        <option value="youtube">{{ trans('dashboard.youtube') }}</option>
                                    </select>
