...
@section('title')
    @lang('dashboard.'.($myTask ? 'my_' : '').'admin_details')
@endsection
...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.'.($myTask ? 'my_' : '').'admin_details')</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">
                            <a href="{{route('admin_details.index')}}"></a>
                            @lang('dashboard.'.($myTask ? 'my_' : '').'admin_details')
                        </li>
                    </ol>
                </div>
        ...
        <div class="row">
            <div class="col-12">
                <h3>
                    ...
                    <a href="{{route('admin_details.create')}}" class="btn btn-info">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="filter-table" style="margin:0 0 30px 0 ;">
                            <form action="{{$myTask == true ? route('admin_details.my') : route('admin_details.index')}}">
                                <div class="row">
                                    {{-- title --}}
                            ...
                            @foreach($tasks as $task)
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        ...
                                        @if(auth('admin')->user()->role == 'admin' and $myTask == false)
                                        <a class="btn btn-primary" href="{{route('admin_details.edit' , $task->id)}}">
    ...
    <script>
        $(function () {
            ...
            $('.show-details').on('click' , function(){
                ...
                console.log('details');
                $.ajax({
                    url : "{{auth('admin')->user()->role == 'admin' ? route('admin_details.index') : route('admin_details.my')}}/" + tag.data('id') , 
                    method : 'GET' , 
            ...
            $('.change-status').on('click' , function(){
                ...
                $.ajax({
                    url : "{{route('admin_details.my')}}/" + tag.data('id') + '/change-status' , 
                    method : 'GET' , 
                    success : function(json){
                        console.log('success');
                        if(json.status){
            ...
            $('body').on('click', '.delete_city', function() {
                ...
                swal({
                    ...
                    {{--var url = '{{ route("imageProductRemove", ":id") }}';--}}
                        ...
                        window.location.href = "{{ url('/') }}" + "/admin/admin_details/delete/"+id;
