...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <div class="row">
                @if (auth('admin')->user()->role != 'developer')
                        ...
                        <div class="small-box bg-success">
                            <div class="inner">
                                <h3>
                                    ...
                                    })->where('archive', 'false')->where('status', 'active')->count() }}
                                </h3>
                            ...
                            <a href="{{ url('/admin/restaurants/active') }}" class="small-box-footer">@lang('messages.details')
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-blue">
                            ...
                            <a href="{{ url('/admin/restaurants/InActive') }}" class="small-box-footer">@lang('messages.details')
                                <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-gray">
                            ...
                            <a href="{{ url('/admin/restaurants/inComplete') }}" class="small-box-footer">@lang('messages.details')
                                <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-dark">
                            ...
                            <a href="{{ url('/admin/branches/in_complete') }}" class="small-box-footer">@lang('messages.details')
                                <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-primary">
                            <div class="inner">
                                <h3>{{ \App\Models\Branch::with('subscription')->whereHas('subscription', function ($q) {$q->where('package_id', 1);})->where('status', 'active')->where('main', 'false')->count() }}
                                </h3>
                ...
                @if (auth('admin')->user()->role == 'admin')
                    ...
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-danger">
                            ...
                            <a href="{{ route('subscription.confirm') }}" class="small-box-footer">@lang('messages.details') <i
                                    class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-3 col-6">
                        ...
                        <div class="small-box bg-success">
                            ...
                            <a href="{{ route('subscription.confirm_branch') }}"
                                class="small-box-footer">@lang('messages.details') <i class="fas fa-arrow-circle-right"></i></a>
                        </div>
                    </div>
